...
public class TeamCommand implements CommandExecutor, TabCompleter {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sendMsg(sender, TeamManager.colorize("&f/t create &8(c)       &7- 创建队伍"));
        sendMsg(sender, TeamManager.colorize("&f/t invite &8(inv)  <玩家> &7- 邀请玩家加入 &8(队长)"));
        sendMsg(sender, TeamManager.colorize("&f/t accept &8(acc) <玩家> &7- 接受邀请/加入申请"));
        sendMsg(sender, TeamManager.colorize("&f/t deny &8(den)   <玩家> &7- 拒绝邀请/加入申请"));
        sendMsg(sender, TeamManager.colorize("&f/t join &8(j)    <队长> &7- 申请加入队伍"));
        sendMsg(sender, TeamManager.colorize("&f/t kick &8(k)    <玩家> &7- 踢出队员 &8(队长)"));
        sendMsg(sender, TeamManager.colorize("&f/t leave &8(l)          &7- 离开队伍"));
        sendMsg(sender, TeamManager.colorize("&f/t disband &8(dis)      &7- 解散队伍 &8(队长)"));
        sendMsg(sender, TeamManager.colorize("&f/t summon &8(s)         &7- 召集队员 &8(队长)"));
        sendMsg(sender, TeamManager.colorize("&f/t s a / t s d          &7- 接受/拒绝召集"));
        sendMsg(sender, TeamManager.colorize("&f/t gui &8(g)            &7- 打开队伍界面"));
        sendMsg(sender, TeamManager.colorize("&f/t info &8(i)           &7- 查看队伍信息"));
        sendMsg(sender, TeamManager.colorize("&f/t list                 &7- 查看所有活跃队伍"));
        sendMsg(sender, TeamManager.colorize("&8&m-----------------------------------"));
    }
